...
<main id="content" class="shell section article">
	<?php while ( have_posts() ) : the_post(); ?>
		<article>
			...
			<section class="service-inquiry"><div><p class="eyebrow">Need this service?</p><h2>Discuss your requirements</h2><p>Share the problem you need solved, relevant systems or platforms, and the outcome you are working toward.</p></div><?php mrk_quote_notice(); mrk_quote_form( get_the_title() ); ?></section>
		</article>
	<?php endwhile; ?>
</main>
<?php get_footer(); ?>
